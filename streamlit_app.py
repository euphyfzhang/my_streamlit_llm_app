...
sql_prompt = 'Generate a sql statement of "' + prompt_q + '" in table DEMO_TABLE with columns (ID, EMPLOYEE_NAME, JOB_TITLE, DATE_OF_HIRE, MANAGER_NAME). column name with double quote'
